...
import 'nifty50_model.dart';
export 'nifty50_model.dart';

class Nifty50Widget extends StatefulWidget {
  const Nifty50Widget({super.key});

  @override
  State<Nifty50Widget> createState() => _Nifty50WidgetState();
}

class _Nifty50WidgetState extends State<Nifty50Widget> {
  late Nifty50Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Nifty50Model());
  }
