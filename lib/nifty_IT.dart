...
import 'nifty_i_t_model.dart';
export 'nifty_i_t_model.dart';

class NiftyITWidget extends StatefulWidget {
  const NiftyITWidget({super.key});

  @override
  State<NiftyITWidget> createState() => _NiftyITWidgetState();
}

class _NiftyITWidgetState extends State<NiftyITWidget> {
  late NiftyITModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NiftyITModel());
  }
