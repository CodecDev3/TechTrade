...
import 'nifty_auto_model.dart';
export 'nifty_auto_model.dart';

class NiftyAutoWidget extends StatefulWidget {
  const NiftyAutoWidget({super.key});

  @override
  State<NiftyAutoWidget> createState() => _NiftyAutoWidgetState();
}

class _NiftyAutoWidgetState extends State<NiftyAutoWidget> {
  late NiftyAutoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NiftyAutoModel());
  }
