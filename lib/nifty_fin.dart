...
import 'nifty_fin_model.dart';
export 'nifty_fin_model.dart';

class NiftyFinWidget extends StatefulWidget {
  const NiftyFinWidget({super.key});

  @override
  State<NiftyFinWidget> createState() => _NiftyFinWidgetState();
}

class _NiftyFinWidgetState extends State<NiftyFinWidget> {
  late NiftyFinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NiftyFinModel());
  }
