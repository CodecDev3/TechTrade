...
import 'nifty_f_m_c_g_model.dart';
export 'nifty_f_m_c_g_model.dart';

class NiftyFMCGWidget extends StatefulWidget {
  const NiftyFMCGWidget({super.key});

  @override
  State<NiftyFMCGWidget> createState() => _NiftyFMCGWidgetState();
}

class _NiftyFMCGWidgetState extends State<NiftyFMCGWidget> {
  late NiftyFMCGModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NiftyFMCGModel());
  }
